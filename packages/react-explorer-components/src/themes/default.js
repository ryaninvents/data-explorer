...
const cyan = 'hsl(198, 99%, 37%)';
const blue = 'hsl(221, 87%, 60%)';
const purple = 'hsl(301, 63%, 40%)';
const green = 'hsl(119, 34%, 47%)';

const red = 'hsl(  5, 74%, 59%)';
const red2 = 'hsl(344, 84%, 43%)';

const orange = 'hsl(41, 99%, 30%);';
const orange2 = 'hsl(41, 99%, 38%);';
